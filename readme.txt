...
The plugin defaults to `openrouter/free` for text and `openrouter/free` for images as there are no free image models available, but you can change this in the settings.
